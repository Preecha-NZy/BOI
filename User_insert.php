...
//-----------------------------insert_ESS and DOC--------------------------------------------------//
function insert_ESS($ESS_ID, $ESS_Model, $ESS_Brand, $ESS_Country, $ESS_Capacity, $ESS_Amount, $ESS_Cost, $ESS_Sum, $conn, $konn)
{
    $sql2 = "INSERT INTO ESS VALUES (?,?,?,?,?,?,?,?)";
    $params = array($ESS_ID, $ESS_Model, $ESS_Brand, $ESS_Country, $ESS_Capacity, $ESS_Amount, $ESS_Cost, $ESS_Sum);
    $r_data = sqlsrv_query($conn, $sql2, $params);
    if ($r_data === false) {
        echo "ERROR 16 : #";
        die(print_r(sqlsrv_errors(), true));
...
if (!is_null($ESS)) {
    ...
    fclose($fp_ESS);
    insert_ESS($ESS_ID, $ESS_Model, $ESS_Brand, $ESS_Country, $ESS_Capacity, $ESS_Amount, $ESS_Cost,$ESS_Sum, $conn, $konn);
    $count = $count + 1;
}
...
// print_r($System_installation_plan);
// echo "\n";

...
<body>
    ...
    <section class="content" style="padding-top: 150px; padding-bottom: 25px;">
        <div class="tab-content">
            <div class="Product zone1">
            ...
            <div class="Rooftop zone1" style="display: none;">
            ...
            <div class="Farm zone1" style="display: none;">
            ...
            <div class="Floating zone1" style="display: none;">
            ...
            <div class="sup-content zone1 total" style="display: none;">
            ...
            <div class="ESS zone1" style="display: none;">
            ...
            <div class="Equipment zone1" style="display: none;">
            ...
            <div class="ESA zone1" style="pointer-events: none;">
        ...
        <div class="btn1" target="#tab1" style="background-color: #ff5252; margin: 0 auto;">
    ...
    <script>
        ...
        let deletes = document.querySelectorAll('.etc-div-delete')
        deletes.forEach(del => {

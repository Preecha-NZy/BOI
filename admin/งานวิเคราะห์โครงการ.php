...
<head>
    ...
    <link rel="stylesheet" href="admin_CSS/งานวิเคราะห์โครงการ.css">
    ...
    <script src="admin_JAVASCRIPT/งานวิเคราะห์โครงการ.js" defer></script>
        ...
        <div class="form-search">
            <div class="row-search">
                <div class="input-search">
                    <label class="search-label" for="">DOC NO.</label>
                    <input type="text">
                </div>
                <div class="input-search">
            ...
            <table cellspacing="0" class="table table-bordered">
                <thead>
                    <tr class="bg-primary">
                        ...
                        <th style="width:7%;">เลขอ้างอิง</th>
                        <th style="width:7%;">DOC NO.</th>
                        <th style="width:7%;">เลขที่คำขอ</th>
                        <th style="width:8%;">วันที่รับคำขอ</th>
                        <th style="width:8%;">วันที่สิ้นสุด</th>
                        <th style="width:25%;">ผู้ยื่นคำขอ</th>

...
<body>
    <section style="position: fixed; width: 100%; top: 0; z-index: 50;">
        ...
        <section class="title-content" style="background-color: #E5E5E5;">
            ...
            <div class="edit-btn head-btn" onclick="test()">
    ...
    <section class="content" style="padding-top: 150px;">
        <div class="Product zone" style="position: relative;  padding: 20px 0;">
            <input class="check-box" type="checkbox" name="" value="ข้อมูลโครงการและรายละเอียดสัญญาการซื้อขาย" id="productDetail" style="position: absolute; top: 0; right: 50px; z-index: 3;" onclick="test2(this)">
        ...
        <div class="Rooftop zone" style="position: relative; margin-top: 50px; display: none; padding: 20px 0;">
            <input class="check-box" type="checkbox" name="" value="รายกาบนหลังคาร" id="rooftop" style="position: absolute; top: 0; right: 50px; z-index: 3;" onclick="test2(this)">
        ...
        <div class="Farm zone" style="position: relative; margin-top: 50px; display: none; padding: 20px 0;">
            <input class="check-box" type="checkbox" name="รายการบนพื้นดิน" id="farm" value="รายการบนพื้นดิน" style="position: absolute; top: 0; right: 50px; z-index: 3;" onclick="test2(this)">
        ...
        <div class="Floating zone" style="position: relative; margin-top: 50px; display: none; padding: 20px 0;">
            <input class="check-box" type="checkbox" name="รายการบนทุ่นลอยน้ำ" id="floating" style="position: absolute; top: 0; right: 50px; z-index: 3;" onclick="test2(this)">
            <div class="FLS">
        ...
        <div class="ESS zone" style="position: relative; margin-top: 50px; display: none;  padding: 20px 0;">
            <input class="check-box" type="checkbox" name="" value="ระบบกักเก็บพลังงาน" id="ess" style="position: absolute; top: 0; right: 50px; z-index: 3;" onclick="test2(this)">
        ...
        <div class="Equipment zone" style="position: relative; margin-top: 50px; display: none; padding: 20px 0;">
            <input class="check-box" type="checkbox" name="" value="รายละเอียดอุปกรณ์อื่นๆ" id="equipment" style="position: absolute; top: 0; right: 50px; z-index: 3;" onclick="test2(this)">
        ...
        <div class="Investment zone" style="position: relative; margin-top: 50px; padding: 20px 0;">
            <input class="check-box" type="checkbox" name="" id="investment" value="รายละเอียดการลงทุนในการออกแบบและติดตั้ง" style="position: absolute; top: 0; right: 50px; z-index: 3;" onclick="test2(this)">
        ...
        <div class="SIP zone" style="position: relative; margin-top: 50px; padding: 20px 0;">
            <input class="check-box" type="checkbox" name="" id="SIP" value="แผนการดำเนินงาน" style="position: absolute; top: 0; right: 50px; z-index: 3;" onclick="test2(this)">
        ...
        <div class="ESA zone" style="position: relative; margin-top: 50px; padding: 20px 0; display: none;">
            <input class="check-box" type="checkbox" name="" id="esa" value="แผนการจัดทำรายงานเกี่ยวกับการศึกษามาตรการป้องกัน" style="position: absolute; top: 0; right: 50px; z-index: 3;" onclick="test2(this)">
        ...
        <div class="edit-content" id="editContent" >
            ...
            <div class="row" style="display: flex; justify-content: center;">
                ...
                <div class="edit-sub-content">
                    <textarea name="" id="" cols="30" rows="10" style="width: 100%; height: 50px; resize: none; padding: 0 5px;"></textarea>
                </div>
            </div>
            <div class="row" style="display: flex; justify-content: center;">
                <div class="edit-sup-content">
            ...
            <div class="confirm-edit" >ยืนยันการส่งแก้ไข</div>
        </div>
        ...
        $solarRequest = $fetchData->fetch_solarRequest($_COOKIE['doc_no']);
        if (isset($solarRequest)) {
            ...
            $sip = $fetchData->fetch_sip($_COOKIE['doc_no']);
            $esa = $fetchData->fetch_esa($_COOKIE['doc_no']);
        }
        ?>
    </section>
    <script>
        ...
        if (rooftopSolar.length > 0) {
            let a = document.getElementsByClassName('Rooftop')[0].style.display = 'block'

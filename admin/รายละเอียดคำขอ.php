...
<body>
    ...
    <section class="main-content" style="padding-top: 150px;">
        <div class="head-content">
            ...
            <div class="head-btn assign-btn" style="margin-left: 2px; display: none" onclick="togglePopup()"><i class="icon-check head-icon"></i>มอบหมายงาน</div>
            ...
            <div class="head-btn accept-assign-btn" style="margin-left: 2px; display: none" onclick="accept()"><i class="fas fa-check head-icon"></i>รับมอบหมาย</div>
        ...
        <div class="title-main-content">คำขอรับหารส่งเสริม</div>
        <div class="row">
        ...
        $sql = $fetchData->checkRequest_info($_COOKIE['doc_no']);
        ...
        <script>
            ...
            if (status != 'รอยืนยันคำขอ') {
                let btn = document.getElementById("receiveRequest")

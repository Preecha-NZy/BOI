        ...
        <div class="tab-content">
                ...
                <form action="#">
                    ...
                    <div class="sup-content" style="margin: 0;">
                        ...
                        <div class="col-sub-content">
                            <div class="row-sub-content">
                                <div class="ip-sf">
                                    <input class="input-page1" type="number" name="กำลังการผลิต" id="Capacity" onkeyup="if(this.value<0){this.value= this.value * -1}" placeholder="กรอกกำลังการผลิต" required>
            ...
            <div id="tab2" data-tab-content>
                ...
                <div class="is-ground-content tab2-content">
                    ...
                    <br>
                    <div class="sup-content">
                        <label for="" class="sup-title">เอกสาร layout การติดตั้งบนพื้นดิน </label>
                        <div class="col-sub-content">
                ...
                <div class="is-pool-content tab2-content">
                    ...
                    <br>
                    <div class="sup-content">
                        <label for="" class="sup-title">เอกสาร layout การติดตั้งบนทุ่นลอยน้ำ </label>
                        <div class="col-sub-content">
                            <label for="" class="sub-title">แนบเอกสาร</label>
                            <div class="row-sub-content">
                ...
                <div class="sup-content">
                    ...
                    <div class="ESS col-sub-content" style="display: none;">
                        ...
                        <div class="row-sub-content">
                            <div class="ip-sf">
                                <input type="number" name="" id="ESS_Cost" onkeyup="if(this.value<0){this.value= this.value * -1}" onchange="essCost()" required>
                                <label for="" class="surfix">บาท</label>
                            </div>
                        </div>
                        <label for="" class="sub-title">กำลังผลิตรวม</label>
